...
func Leela_endpoint_load(endpoint string) *C.struct_leela_endpoint_t {
...
func Lql_new_context(endpoint Leela_endpoint, username string, secret string, timeout int) *C.struct_leela_lql_context_t {
